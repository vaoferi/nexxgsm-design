...
- фон: один CSS-градієнт `linear-gradient(45deg, #0d3f67, #082b47, #010508)` із 200% полотном та 12-секундною анімацією працює на всіх viewport; понад 700px прозора сцена додає монітор і клавіатуру поверх нього, а mobile не запускає WebGL;
